    ...
    */
    ...
    private class seekBarListener implements OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            progressValue = progressValue - 128;
            Log.i("SeekBar", "value: "+progressValue );
            SeekBarState.getInstance().setBrightnessDelta(progressValue);

            TextView seekBarValue = (TextView) findViewById(R.id.seekBarText);
            seekBarValue.setText(""+SeekBarState.getInstance().getBrightnessDelta());
        }
